...
# Additional variables to account for statistical tests
param$latent_vars = c()
...
# condition_group1: condition levels in group 1; can also be multiple levels concatenated by the plus character; empty string = all levels not in group2 (cannot be used if group2 is empty)
# condition_group2: condition levels in group 2; separate multiple levels concatenated by the plus character; empty string = all levels not in group1 (cannot be used if group1 is empty)
#
# These columns are optional:
# subset_column: categorial column in the cell metadata to subset before testing; specify "orig.ident" for sample and "seurat_clusters" for cluster (default: NA/no subset)
# subset_group: subset levels; for the individual analysis of multiple levels separate by semicolons; for the joint analysis of multiple levels concatenate by the plus character (default: NA)
