...
if (param$integrate_samples[["method"]]=="merge") {
  ...
  sc = ScAddLists(sc, lists=list(samples=param$col_samples), lists_slot="colour_lists")
...
if (markers_found) {
  ...
  # Add to markers slot of  the seurat object
  # TODO: Seurat::Misc(sc, "markers") = c(Seurat::Misc(sc, "markers"), enrichr=)
}
```
