...
if (param$integrate_samples[["method"]]!="single") {
  ...
  assay_names = setdiff(assay_names, "SCT")
...
Seurat::Misc(sc, "markers") = markers_filt
...
if (markers_found) {
  ...
  markers_filt = Seurat::Misc(sc, "markers") 
...
"wilcox", "bimod", "roc", "t", "negbinom", "poisson", "LR", "MAST", "DESeq2"; (default: "wilcox")

degs_contrasts_list[[1]]$test="DESeq2"
