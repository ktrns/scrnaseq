...
p = Seurat::DimPlot(sc, reduction="umap", group.by="seurat_clusters") + 
  AddStyle(title="UMAP, cells coloured by cluster identity", legend_position="none", legend_title="Clusters") + 
  scale_color_manual(values=param$col_clusters, labels=cluster_labels)
p = LabelClusters(p, id="seurat_clusters", box=TRUE, segment.color="black", fill=param$col_clusters)
p
```
...
p1 = LabelClusters(p1, id="ident", box=FALSE, segment.color="black")
