...
# The params object should not be modified because R/knitr seem load/update it dynamically from the YAML thereby overwriting local changes. We make a copy.
param = params
