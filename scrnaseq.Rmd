...
features_filter = 1 # feature has to be hit by at least one count in one cell 
...
# Filter features
features_count_sum = Matrix::rowSums(Seurat::GetAssayData(sc, slot="counts", assay="RNA"))
features_keep = which(features_count_sum > features_filter)
