...
```{r featurePlot_knownMarkers_dotplot, fig.height=fig_height_knownMarkers_dotplot, eval=(known_markers_n!=0)}
if (any(idx_dotplot)) {
...
```{r featurePlot_knownMarkers_umap, fig.height=fig_height_knownMarkers_avgplot, eval=(known_markers_n!=0)}
if (any(idx_avgplot)) {
...
```{r featurePlot_knownMarkers_all, fig.height=fig_height_knownMarkers_vect, eval=(known_markers_n!=0)}
