...
For each gene, we calculate its median expression across all cells, and then calculate the deviation from this median for each cell. For each cell, we plot the median expression (black), the interquartile range ([lightgrey]{style="color:lightgrey;font-weight:bold"}), whiskers defined as 1.5 times the interquartile range ([darkgrey]{style="color:darkgrey;font-weight:bold"}), and outliers (`r paste0('<span style="color:', param$col_samples, ';font-weight:bold">', param$col_samples, '</span>', collapse=', ')`)
...
-   export/
    -   Loupe_projection\_(umap\|pca\|...).csv: Seurat UMAP/PCA/... projections for visualization
...
-   marker_degs/
    ...
    -   functions_marker_up_cluster\_[1,2,3,...]\_vs_rest.xslx: Biological functions and pathways that were found enriched in the up-regulated markers for cluster 1, 2, 3, ... (Excel format)
    -   functions_marker_down_cluster\_[1,2,3,...]\_vs_rest.xslx: Biological functions and pathways that were found enriched in the down-regulated markers for cluster 1, 2, 3, ... (Excel format)
    -   degs_contrast_row\_[1,2,3,...]\_results.xlsx: Results (genes) of the DEG analysis specified in the first, second, third, ... row of the configuration parameter (Excel format)
    -   degs_contrast_row\_[1,2,3,...]\_functions.xlsx: Results (enriched functions and pathways) of the DEG analysis specified in the first, second, third, ... row of the configuration parameter (Excel format)
