...
# Note: both mart objects must point to the same host for biomarT::getLDS to work
mart_human = GetBiomart(biomart="ensembl", dataset="hsapiens_gene_ensembl", mirror=mirror)
mart_human_host = gsub(pattern=":\\d+$", replacement="", x=gsub(pattern="[^/]/[^/]\\S+", replacement="", x=mart_human@host))
mart_myspecies = GetBiomart(biomart="ensembl", dataset=param$mart_dataset, host=mart_human_host) 
