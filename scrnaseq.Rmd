...
params:
   ...
   mart_attributes: !r c(params$annot_main, 
   ...
   #####################
   # Filter for cells
   cell_filter: !r list(nFeature_RNA=c(200, NA), percent_mt=c(NA, 20))
   ...
   enrichr_dbs: !r c("GO_Molecular_Function_2018", "GO_Biological_Process_2018", "GO_Cellular_Component_2018")
