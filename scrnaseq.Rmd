...
knitr::opts_chunk$set(echo=TRUE, cache=FALSE, message=TRUE, warning=TRUE, tidy=FALSE, fig.width=10)
...
sc = Seurat::FindClusters(sc, resolution=param$cluster_resolution, algorithm=1, verbose=FALSE)
...
sc_markers = Seurat::FindAllMarkers(sc, assay="RNA", test.use="MAST",
                                    only.pos=FALSE, min.pct=0.75, logfc.threshold=0.25,
