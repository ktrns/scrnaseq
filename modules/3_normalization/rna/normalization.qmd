...
for(i in seq_along(layers)) {
  n = paste(gsub("^data\\.", "", layers[i]), default_assay, "data", sep=".")
  matrix_dir = BPCells::write_matrix_dir(mat=SeuratObject::LayerData(sc, assay=default_assay, layer=layers[i]),
                            dir=file.path(module_dir, "tmp", n),
