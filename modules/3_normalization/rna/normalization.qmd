...
if (param("normalisation_method") == "lognorm") {
...
} else if(param("normalisation_method") == "scran") {
  # Scran
  with_progress({
...
} else if(param("normalisation_method") == "SCT") {
  # SCTransform
  sc = SCTransform(sc, 
  ...
  Seurat::DefaultAssay(sc) = paste0(default_assay, "sct")
  layers = c()
...
if (on_disk_counts & param("normalisation_method") != "SCT") {
