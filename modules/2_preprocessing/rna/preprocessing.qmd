...
sc = Seurat::RunPCA(sc, verbose=FALSE)
default_reduction = "pca"

num_datasets = length(SeuratObject::Layers(sc, search="^data\\."))
if (num_datasets > 1) {
...
# Make ridge plots
plist2 = Seurat::RidgePlot(sc, features=barcode_qc, group.by="seurat_clusters", combine=FALSE)
