...
barcode_metadata = purrr::map_dfr(seq_along(counts_lst), function(i) {
  ...
  metadata$orig_barcode = bc_meta$orig_barcode
  return(metadata)
})
...
note: quarto allows to hide content

```{r}
#| label: add_images
#| eval: !expr "have_images"
#| include: !expr "have_images"
#| timeit: !expr "have_images"
...
for (i in seq_along(counts_lst)) {
  ...
  if (!is.null(image_dir)) {
    ...
    # Add image (10x visium) / field of view (10x xenium)
