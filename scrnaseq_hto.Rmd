...
# Current project
* HTO test dataset
* 'pbmc_hto_mtx.rds' and 'pbmc_umi_mtx.rds' downloaded from the Seurat HTO vignette
* Data were processed to copy the standard CellRanger output
...
# Just one simple sc-RNA-seq sample?
run.standard = TRUE
...
param$path = "~/scrnaseq_refDatasets/10x_pbmc_hto_GSE108313/"
...
param$path.data = "~/scrnaseq_refDatasets/10x_pbmc_hto_GSE108313/cellranger/"
