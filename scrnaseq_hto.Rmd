...
if (any(hto_counts_row$HtoCounts == 0)) {
  sc = subset(sc, features=rownames(which(hto_counts_row$HtoCounts == 0)))
...
```{r hto_normalisation}
# HTO
sc = suppressWarnings(Seurat::NormalizeData(sc, assay="HTO", normalization.method="CLR", verbose=FALSE))
```
