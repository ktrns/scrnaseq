...
```{r hto_normalisation}
# HTO
sc = Seurat::NormalizeData(sc, assay="HTO", normalization.method=params$norm, verbose=FALSE)
```
...
sc.all = Seurat::NormalizeData(sc.all, assay="RNA", normalization.method = "LogNormalize", scale.factor=10000, verbose=FALSE)
